...
Because sachets are frequently filled in small and often unregulated facilities, inadequate sanitary conditions can occasionally result in disease or contamination. However, in countries like Ghana consumers still prefer that access over other forms of venders, with a perception of lower risk. This form of water distribution provides vital access to water in communities that otherwise wouldn't have it. However, some scholars have identified this method of distribution as having potential human rights and social justice issues, limiting the right to water and sanitation.
                ...
                <article className={current === 1 ? "active" : 'gone'} >
                  ...
                  <p>
                  One of our best-selling products is our 15-liter spring water bottles. Customers adore the crisp, refreshing flavor of our water and keep coming back for more bottles. 
                  </p>

                  <p>
                  We are pleased to announce that our bottles are completely recyclable and contain 30% less plastic than our previous bottles. They contain no BPA at all.
                  </p>
                </article>
                ...
                <aside className={current === 2 ? "active" : 'gone'}>
                  <ul>
                    ...
                    <li>
                      ...
                      <p><strong>Depth:</strong> 372mm</p> 
                      <p><strong>Height:</strong> 1003mm</p> 
                      <p><strong>Width:</strong> 318mm</p> 
                    </li>
                    <li>
                      <p>
                        <strong>Weight:</strong>
                      </p>
                      <p><strong>Small water bottle:</strong> 8-12 oz: 0.4 to 0.6 pounds (approximately)</p> 
                      <p><strong>Medium water bottle:</strong> 16-20 oz: 0.8 to 1 pounds (approximately)</p> 
                      <p><strong>Large water bottle:</strong> 24-32 oz: 1.2 to 1.5 pounds (approximately)</p> 
